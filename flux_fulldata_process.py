...
def process_hour_file(data, site_id, pd_site_param, output_dir):
    ...
    # Process SW_IN_F
    ALAT = pd_site_param[pd_site_param['site_id'] == site_id]['LOCATION_LAT'].values[0] # get site Latitude
...
if __name__ == "__main__":
    ...
    site_info_file = 'all_sites_param.csv'
    ...
    for file_name in all_zip:
        ...
        with ZipFile(file_name, 'r') as zip:
            ...
            hh_file = file_prefix[:-14]+ '_HH'+ file_prefix[-14:] + '.csv'  # Half Hour file
            hr_file = file_prefix[:-14]+ '_HR'+ file_prefix[-14:] + '.csv'  # Hourly file
            dd_file = file_prefix[:-14]+ '_DD'+ file_prefix[-14:] + '.csv'  # Daily file
